classdef topsTreeNodeTaskSingleCPDotsReversal < topsTreeNodeTask
    ...
    properties % (SetObservable) % uncomment if adding listeners
        ...
        settings = struct( ...
            ...
            'directionPriors',            [50 50], ... % change For asymmetric priors
            'referenceRT',                [],   ...
            'fixationRTDim',              0.4,  ...
            'targetDistance',             8,    ...
            'textStrings',                '',   ...
        ...
        independentVariables = struct( ...
            ...
            [100], ...%[0 3.2 6.4 12.8 25.6 51.2], ... %coherence
            [1],...%.1:.1:.5, ...                      %viewingDuration
            [1], ...[.1,.5,.9], ...                    %probCP
            [.5]}, ...%[.1,.2,.3]}, ...                 %timeCP
            'priors',      {[], [], [], [], []}, ...
            'minTrials',   {1, [], [], [], []});
    ...
    methods (Access = protected)
        ...
        function initializeStateMachine(self)
            ...
            states = {...
                ...
                'switchDots'        switchd  {}       0                         {}      'showDotsEpoch2'  ; ...
                'showDotsEpoch2'    showdFX  {}       t.dotsDuration2           hided   'waitForChoiceFX' ; ...
    ...
    methods (Static)
        ...
        function task = getStandardConfiguration(name, minTrialsPerCondition, varargin)
            ...
            task.setIndependentVariableByName('initDirection', 'priors', [50 50]);
        end
    end
end
