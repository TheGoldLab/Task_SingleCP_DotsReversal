...
strs = { ...
    ...
    'dotsReadableHIDKeyboard', paceStr, 'Press space bar to fixate. Answer with L/R arrows.'; ...
...
for ii = 1:2:length(taskSpecs)
    ...
    task.recordDotsPositions = topNode.nodeData{'Settings'}{'recordDotsPositions'};
